...
import com.example.foodflix.ui.map.adapter.LocationRecyclerViewAdapter;
import com.example.foodflix.ui.map.model.IndividualLocation;
import com.example.foodflix.ui.map.util.LinearLayoutManagerWithSmoothScroller;
...
import static com.example.foodflix.ui.map.util.StringConstants.SELECTED_THEME;
...
public class MapActivity extends AppCompatActivity implements
    ...
    private static final LatLngBounds LOCKED_MAP_CAMERA_BOUNDS = new LatLngBounds.Builder()
            .include(new LatLng(6.871239931696877, 79.8618452655096))
            .include(new LatLng(5.871239931696877, 78.8618452655096))
            .build();
    private static final LatLng MOCK_DEVICE_LOCATION_LAT_LNG = new LatLng(6.871203, 79.861855);
        ...
        private void initializeTheme() {
            switch (selectedTheme) {
                case R.style.AppTheme_Blue:
                    ...
                    unselectedMarkerIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.pin);
                    selectedMarkerIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.pin_selected);
